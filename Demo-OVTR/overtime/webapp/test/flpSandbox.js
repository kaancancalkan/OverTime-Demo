		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "request",
									"targetURL": "#employeeovertime-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"employeeovertime-display": {
								"semanticObject": "employeeovertime",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=employee.overtime",
									"url": sap.ui.require.toUrl("employee/overtime")
								}
							}
						}
					}
